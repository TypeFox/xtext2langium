...
public abstract class AbstractXtextTests extends Assert {
	 ...
	 */
	protected void with(com.google.inject.Module[] modules) throws Exception {
	...
	protected String readFileIntoString(String filePath) throws IOException {
		...
		throw new IllegalStateException(
				"May not happen, but helps to suppress false positives in eclipse' control flow analysis.");
	}
